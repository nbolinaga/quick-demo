...
const Home: NextPage = () => {
  ...
  return (
    <>
      <div className="relative flex items-center flex-col flex-grow p-5 pt-10 md:h-screen bg-cover bg-fixed bg-center bg-[url('/stars.jpeg')] overflow-hidden ">
        <div className="absolute left-1/2 top-1/2 md:top-full z-10 flex h-screen w-full -translate-x-1/2 -translate-y-1/2 items-end justify-center ">
          <Image
            src={"/moon.png"}
            width={1000}
            height={1000}
        ...
        {isConnected ? (
          <div className="relative bg-neutral/90 p-5 md:p-10 !rounded-xl w-full md:w-1/3 z-40 mx-5 md:mx-0">
            <div className="rounded-box p-5 flex flex-col">
              ...
              <p className="underline text-secondary cursor-pointer my-2 text-center flex justify-center items-center space-x-2 text-xs md:text-md">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                ...
                <Link href="https://hodlprotocol.gitbook.io/hodl-academy" target="_blank">
                  {" "}
          ...
          <p className="text-[#c1ea60] text-lg md:text-3xl bg-black">Please connect your wallet to start!</p>
        )}
      </div>
